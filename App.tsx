...
const App: React.FC = () => {
  ...
  <div class="flex items-center gap-3 cursor-pointer">
    <span class="text-2xl font-black text-white italic tracking-tighter group">
      GNP<span class="text-brand-navy group-hover:text-white transition-colors">GO</span>
    </span>
  </div>
</nav>
          ...
          <div className="animate-fade-in-up [animation-delay:300ms] opacity-0 h-full">
            <TiltCard className="h-full">
              <div className="bg-gradient-to-br from-white to-orange-50 backdrop-blur-xl border-2 border-white/60 p-8 rounded-[2.5rem] shadow-2xl h-full flex flex-col relative overflow-hidden">
                ...
                <p className="text-gray-500 mb-8 leading-relaxed font-medium">Chương trình luyện thi chất lượng cao dành cho học sinh các cấp với cam kết đầu ra.</p>
                ...
                <div className="space-y-4 mb-10 flex-grow">
                  <div className="flex items-center gap-4 bg-white/60 p-4 rounded-2xl border border-white/50 shadow-sm transition-transform hover:translate-x-2">
                    ...
                    <span className="font-bold text-lg text-brand-navy">Giảm 20% học phí</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/60 p-4 rounded-2xl border border-white/50 shadow-sm transition-transform hover:translate-x-2">
                    <div className="bg-orange-100 p-2 rounded-full"><Gift className="w-5 h-5 text-brand-orange" /></div>
                    <span className="font-medium text-brand-navy">Tặng 01 bộ tài liệu ôn tập</span>
                  </div>
                </div>
          ...
          <div className="animate-fade-in-up [animation-delay:500ms] opacity-0 h-full">
            <TiltCard className="h-full" intensity={18}>
              <div className="bg-gradient-to-br from-brand-navy via-[#16216A] to-blue-900 backdrop-blur-xl border-2 border-blue-400/30 p-8 rounded-[2.5rem] shadow-2xl h-full flex flex-col relative overflow-hidden text-white ring-1 ring-white/10">
                ...
                <div className="w-20 h-20 bg-white/10 rounded-3xl flex items-center justify-center mb-8 text-yellow-400 transition-transform duration-500 hover:rotate-[-12deg] hover:scale-110 border border-white/10">
                   <Gift className="w-10 h-10" />
                </div>

                <h4 className="text-3xl font-black text-white mb-3">GNP English Academy</h4>
                <p className="text-blue-200 mb-8 leading-relaxed font-medium">Khóa học tiếng Anh chuẩn quốc tế giúp bạn tự tin giao tiếp.</p>
                
                <div className="space-y-4 mb-10 flex-grow">
                  <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl border border-white/10 shadow-sm transition-transform hover:translate-x-2">
                    <div className="bg-yellow-400 p-2 rounded-full text-brand-navy font-bold text-xs">FREE</div>
                    <span className="font-bold text-xl text-yellow-400">Tặng 01 khóa học</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl border border-white/10 shadow-sm transition-transform hover:translate-x-2">
                    <div className="bg-blue-500/30 p-2 rounded-full"><CheckCircle className="w-5 h-5 text-blue-300" /></div>
                    <span className="font-medium text-blue-100">Khi đăng ký 03 khóa liên tiếp</span>
                  </div>
                </div>
